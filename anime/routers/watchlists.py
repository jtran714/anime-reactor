...
from models import WatchlistIn, WatchlistOut, ErrorMsg
from queries.watchlists import WatchlistQueries
from authenticator import authenticator

router = APIRouter()

@router.post("/api/watchlists/{watchlist_id}/data", response_model=WatchlistOut)
